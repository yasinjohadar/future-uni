...
<div class="main-content app-content">
    <div class="container-fluid">
        ...
        @include('admin.partials.ui.page-header', [
            ...
            'subtitle' => 'إنشاء حساب طالب وربطه ببرنامج أكاديمي',
        ...
        <form method="POST" action="{{ route('admin.people.students.store') }}">
            @csrf

            <div class="row g-4">
                <div class="col-lg-8 order-lg-1">
                    @include('admin.people.students.partials.form-fields', ['programs' => $programs])
                </div>
                <div class="col-lg-4 order-lg-2">
                    @include('admin.people.students.partials.form-sidebar', ['programs' => $programs])
                </div>
            </div>
        </form>
    </div>
