    ...
    <div class="container-fluid">
        ...
        <div class="row g-3 mb-4">
            @include('admin.partials.ui.stat-card-gradient', [
                ...
                'label' => 'الكليات',
                'value' => number_format($stats['colleges_total'] ?? 0),
                'hint' => number_format($stats['programs_total'] ?? 0) . ' برنامج',
            ])
            @include('admin.partials.ui.stat-card-gradient', [
                'variant' => 'green',
                'icon' => 'ri-file-list-3-line',
                'label' => 'طلبات قبول معلقة',
                'value' => number_format($stats['admission_pending'] ?? 0),
            ...
            @include('admin.partials.ui.stat-card-gradient', [
                ...
                'label' => 'الهيئة',
                'value' => number_format($stats['staff_total'] ?? 0),
                'hint' => 'إدارة وتدريس',
            ])
            @include('admin.partials.ui.stat-card-gradient', [
                'variant' => 'orange',
                ...
                'label' => 'الطلاب',
                'value' => number_format($stats['students_total'] ?? 0),
                'hint' => 'SIS Lite',
            ])
        </div>
