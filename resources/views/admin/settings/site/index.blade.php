...
<div class="main-content app-content">
    <div class="container-fluid">
        ...
        <div class="settings-layout row g-4"
            ...
            <div class="col-lg-9">
                <form action="{{ route('admin.settings.site.update') }}" method="POST" id="siteSettingsForm" class="settings-form">
                    @csrf
                    @method('PUT')
                    ...
                    @foreach($sections as $id => $section)
                        <div class="settings-panel {{ $activeSection === $id ? 'is-active' : '' }}"
                            ...
                            <div class="card custom-card form-card settings-panel-card mb-0">
                                <div class="card-header">
                                    <h6 class="settings-panel__title mb-1">
                    ...
                    <div class="card custom-card form-card settings-actions-card">
