            ...
            <div class="main-sidebar" id="sidebar-scroll">
                ...
                <nav class="main-menu-container nav nav-pills flex-column sub-open">
                    ...
                    <ul class="main-menu">
                        ...
                        @php
                            $isAcademicOpen = request()->routeIs('admin.academic.*');
                            $isResearchOpen = request()->routeIs('admin.research.*');
                            $isLibraryOpen = request()->routeIs('admin.library.*');
                            $isPeopleOpen = request()->routeIs('admin.people.*');
                            $isAdmissionOpen = request()->routeIs('admin.admission.*');
                            $isSiteContentOpen = request()->routeIs(['admin.homepage.*', 'admin.settings.site.*']);
                        @endphp

                        <li class="slide has-sub {{ $isSiteContentOpen ? 'open active' : '' }}">
                            <a href="javascript:void(0);" class="side-menu__item {{ $isSiteContentOpen ? 'active' : '' }}">
                                <span class="side-menu__icon side-menu__icon--boxed side-menu__icon--blog">
                                    <i class="ri-layout-line"></i>
                                </span>
                                <span class="side-menu__label">المحتوى والموقع</span>
                                <i class="ri-arrow-left-s-line side-menu__angle"></i>
                            </a>
                            <ul class="slide-menu child1">
                                <li class="slide {{ request()->routeIs('admin.homepage.*') ? 'active' : '' }}">
                                    <a href="{{ route('admin.homepage.index') }}" class="side-menu__item">الصفحة الرئيسية</a>
                                </li>
                        ...
                        <li class="slide has-sub {{ $isAcademicOpen ? 'open active' : '' }}">
                            <a href="javascript:void(0);" class="side-menu__item {{ $isAcademicOpen ? 'active' : '' }}">
                                <span class="side-menu__icon side-menu__icon--boxed side-menu__icon--roles">
                                    <i class="ri-building-4-line"></i>
                                </span>
                                <span class="side-menu__label">الهيكل الأكاديمي</span>
                                <i class="ri-arrow-left-s-line side-menu__angle"></i>
                            </a>
                            <ul class="slide-menu child1">
                                <li class="slide {{ request()->routeIs('admin.academic.colleges.*') ? 'active' : '' }}">
                                    <a href="{{ route('admin.academic.colleges.index') }}" class="side-menu__item">الكليات</a>
                                </li>
                                <li class="slide {{ request()->routeIs('admin.academic.departments.*') ? 'active' : '' }}">
                                    <a href="{{ route('admin.academic.departments.index') }}" class="side-menu__item">الأقسام</a>
                                </li>
                        ...
                        <li class="slide has-sub {{ $isResearchOpen ? 'open active' : '' }}">
                            <a href="javascript:void(0);" class="side-menu__item {{ $isResearchOpen ? 'active' : '' }}">
                                <span class="side-menu__icon side-menu__icon--boxed side-menu__icon--blog">
                                    <i class="ri-flask-line"></i>
                                </span>
                                <span class="side-menu__label">البحث العلمي</span>
                                <i class="ri-arrow-left-s-line side-menu__angle"></i>
                            </a>
                            <ul class="slide-menu child1">
                                <li class="slide {{ request()->routeIs('admin.research.centers.*') ? 'active' : '' }}">
                                    <a href="{{ route('admin.research.centers.index') }}" class="side-menu__item">مراكز البحث</a>
                                </li>
                            </ul>
                        </li>

                        <li class="slide has-sub {{ $isLibraryOpen ? 'open active' : '' }}">
                            <a href="javascript:void(0);" class="side-menu__item {{ $isLibraryOpen ? 'active' : '' }}">
                                <span class="side-menu__icon side-menu__icon--boxed side-menu__icon--blog">
                                    <i class="ri-book-open-line"></i>
                                </span>
                                <span class="side-menu__label">المكتبة الجامعية</span>
                                <i class="ri-arrow-left-s-line side-menu__angle"></i>
                            </a>
                            <ul class="slide-menu child1">
                                <li class="slide {{ request()->routeIs('admin.library.books.*') ? 'active' : '' }}">
                                    <a href="{{ route('admin.library.books.index') }}" class="side-menu__item">الكتب</a>
                                </li>
                                <li class="slide {{ request()->routeIs('admin.library.categories.*') ? 'active' : '' }}">
                                    <a href="{{ route('admin.library.categories.index') }}" class="side-menu__item">التصنيفات</a>
                                </li>
                        ...
                        <li class="slide has-sub {{ $isPeopleOpen ? 'open active' : '' }}">
                            <a href="javascript:void(0);" class="side-menu__item {{ $isPeopleOpen ? 'active' : '' }}">
                                <span class="side-menu__icon side-menu__icon--boxed side-menu__icon--users">
                                    <i class="ri-user-star-line"></i>
                                </span>
                                <span class="side-menu__label">الأشخاص</span>
                                <i class="ri-arrow-left-s-line side-menu__angle"></i>
                            </a>
                            <ul class="slide-menu child1">
                                <li class="slide {{ request()->routeIs('admin.people.staff.*') ? 'active' : '' }}">
                                    <a href="{{ route('admin.people.staff.index') }}" class="side-menu__item">الهيئة الإدارية والتدريس</a>
                                </li>
                                <li class="slide {{ request()->routeIs('admin.people.students.*') ? 'active' : '' }}">
                                    <a href="{{ route('admin.people.students.index') }}" class="side-menu__item">الطلاب (SIS)</a>
                                </li>
                            </ul>
                        </li>

                        <li class="slide has-sub {{ $isAdmissionOpen ? 'open active' : '' }}">
                            <a href="javascript:void(0);" class="side-menu__item {{ $isAdmissionOpen ? 'active' : '' }}">
                                <span class="side-menu__icon side-menu__icon--boxed side-menu__icon--consultation">
                                    <i class="ri-file-list-3-line"></i>
                                </span>
                                <span class="side-menu__label">القبول والتسجيل</span>
                                <i class="ri-arrow-left-s-line side-menu__angle"></i>
                            </a>
                            <ul class="slide-menu child1">
                                <li class="slide {{ request()->routeIs('admin.admission.applications.*') ? 'active' : '' }}">
                                    <a href="{{ route('admin.admission.applications.index') }}" class="side-menu__item">طلبات القبول</a>
                                </li>
                                <li class="slide {{ request()->routeIs('admin.admission.cycles.*') ? 'active' : '' }}">
                                    <a href="{{ route('admin.admission.cycles.index') }}" class="side-menu__item">فترات القبول</a>
                                </li>
                            </ul>
                        </li>
