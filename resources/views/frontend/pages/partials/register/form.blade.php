        ...
        <div class="auth-wrapper">
            ...
            <div class="auth-branding">
                <div class="branding-content">
                    ...
                    <p class="branding-text">أنشئ حسابك وابدأ رحلتك التعليمية مع أفضل الدورات والمدربين على مستوى
                        المنطقة.</p>
                    ...
                    <form class="auth-form" id="registerForm">
                        <div class="row g-3">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-wrapper">
                                        <input type="text" class="form-control" id="firstName" placeholder="أحمد"
                                            required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-wrapper">
                                        <input type="text" class="form-control" id="lastName" placeholder="محمد"
                                            required>
                                        <span class="input-focus-border"></span>
                                    </div>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrapper phone-input">
                                <select class="form-select phone-code" id="phoneCode">
                        ...
                        <div class="form-group">
                            <label class="checkbox-wrapper terms-checkbox">
                                ...
                                <span class="checkbox-label">أوافق على <a href="#" target="_blank">الشروط والأحكام</a>
                                    و<a href="#" target="_blank">سياسة الخصوصية</a></span>
                            </label>
                        </div>
