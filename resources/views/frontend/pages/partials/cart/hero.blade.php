<div class="page-hero">
        <div class="page-hero-content container">
            <div class="page-hero-icon"><i class="fas fa-shopping-cart"></i></div>
            <h1 class="page-hero-title">سلة المشتريات</h1>
            <p class="page-hero-subtitle">راجع كورساتك المختارة وأكمل عملية الدفع بكل أمان وسهولة.</p>
