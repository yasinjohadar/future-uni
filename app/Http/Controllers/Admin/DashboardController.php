...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        $admissionPending = AdmissionApplication::where('status', AdmissionApplicationStatus::Pending->value)->count();

        $badges = [
            'contact_unread' => $contactUnread,
            'consultation_unread' => $consultationUnread,
            'admission_pending' => $admissionPending,
        ];
