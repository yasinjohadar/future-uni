...
class SiteSettingsService
{
    ...
    public function getSettings(): array
    {
        ...
        return [
            ...
            'default_seo_title' => $settings['default_seo_title'] ?? config('app.name'),
            'default_seo_description' => $settings['default_seo_description'] ?? 'جامعة المستقبل — تعليم أكاديمي متميز',
