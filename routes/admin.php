...
use App\Http\Controllers\Admin\Research\ResearchCenterController;
...
use App\Http\Controllers\Admin\Library\LibrarySettingController;
...
Route::middleware(['auth', 'check.user.active'])->prefix('admin')->name('admin.')->group(function () {
    Route::bind('staff', fn (string $value) => StaffMember::findOrFail($value));
    Route::bind('cycle', fn (string $value) => AdmissionCycle::findOrFail($value));
    Route::bind('application', fn (string $value) => AdmissionApplication::findOrFail($value));
    Route::bind('heroSlide', fn (string $value) => HomepageHeroSlide::findOrFail($value));
    Route::bind('stat', fn (string $value) => HomepageStat::findOrFail($value));
    Route::bind('accreditation', fn (string $value) => Accreditation::findOrFail($value));
    ...
    Route::prefix('academic')->name('academic.')->group(function () {
        ...
        Route::post('colleges/{college}/toggle-active', [CollegeController::class, 'toggleActive'])->name('colleges.toggle-active');
    ...
    Route::prefix('research')->name('research.')->group(function () {
        Route::resource('centers', ResearchCenterController::class)->parameters(['centers' => 'research_center']);
        Route::post('centers/{research_center}/toggle-active', [ResearchCenterController::class, 'toggleActive'])->name('centers.toggle-active');
    });

    Route::prefix('library')->name('library.')->group(function () {
        Route::resource('categories', LibraryCategoryController::class)->parameters(['categories' => 'library_category'])->except(['show']);
        Route::post('categories/{library_category}/toggle-active', [LibraryCategoryController::class, 'toggleActive'])->name('categories.toggle-active');

        Route::resource('books', LibraryBookController::class)->parameters(['books' => 'library_book']);
        Route::post('books/{library_book}/toggle-active', [LibraryBookController::class, 'toggleActive'])->name('books.toggle-active');
    ...
    Route::prefix('people')->name('people.')->group(function () {
        Route::resource('staff', StaffMemberController::class)->parameters(['staff' => 'staff']);
        Route::post('staff/{staff}/toggle-active', [StaffMemberController::class, 'toggleActive'])->name('staff.toggle-active');
        Route::resource('students', \App\Http\Controllers\Admin\People\StudentController::class);
    });

    // Admission routes
    Route::prefix('admission')->name('admission.')->group(function () {
        Route::resource('cycles', AdmissionCycleController::class)->parameters(['cycles' => 'cycle']);
        Route::post('cycles/{cycle}/toggle-active', [AdmissionCycleController::class, 'toggleActive'])->name('cycles.toggle-active');

        Route::get('applications/export', [AdmissionApplicationController::class, 'export'])->name('applications.export');
        Route::get('applications', [AdmissionApplicationController::class, 'index'])->name('applications.index');
        Route::get('applications/{application}', [AdmissionApplicationController::class, 'show'])->name('applications.show');
        Route::patch('applications/{application}/status', [AdmissionApplicationController::class, 'updateStatus'])->name('applications.update-status');
    });
    ...
    Route::prefix('homepage')->name('homepage.')->group(function () {
        ...
        Route::post('hero-slides', [HomepageController::class, 'storeHeroSlide'])->name('hero-slides.store');
        Route::put('hero-slides/{heroSlide}', [HomepageController::class, 'updateHeroSlide'])->name('hero-slides.update');
        Route::delete('hero-slides/{heroSlide}', [HomepageController::class, 'destroyHeroSlide'])->name('hero-slides.destroy');
        Route::post('hero-slides/{heroSlide}/toggle-active', [HomepageController::class, 'toggleHeroSlideActive'])->name('hero-slides.toggle-active');
        ...
        Route::delete('stats/{stat}', [HomepageController::class, 'destroyStat'])->name('stats.destroy');
        Route::post('stats/{stat}/toggle-active', [HomepageController::class, 'toggleStatActive'])->name('stats.toggle-active');

        Route::post('accreditations', [HomepageController::class, 'storeAccreditation'])->name('accreditations.store');
        Route::put('accreditations/{accreditation}', [HomepageController::class, 'updateAccreditation'])->name('accreditations.update');
        Route::delete('accreditations/{accreditation}', [HomepageController::class, 'destroyAccreditation'])->name('accreditations.destroy');
        Route::post('accreditations/{accreditation}/toggle-active', [HomepageController::class, 'toggleAccreditationActive'])->name('accreditations.toggle-active');
    });
